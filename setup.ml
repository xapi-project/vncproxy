...
(* OASIS_START *)
(* DO NOT EDIT (digest: 56756eb180c7f2f5423346087acdbbf5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["David Scott"; "Marcello Seri <marcello.seri@citrix.com>"];
          homepage = Some "https://github.com/xapi-project/vncproxy";
          bugreports = None;
          synopsis = "Connect to remote XenServer VM consoles";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "vncproxy.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some "https://github.com/xapi-project/vncproxy";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "!})\195~\162\002\197\003-\175\025\245,\012R";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
